...
with ic1:
    FA=st.number_input("**Total floor area [m^2]:**",min_value=100,max_value=300,step=10,value=150)
    AR=st.number_input("**Aspect ratio:**",min_value=0.1,max_value=1.0,step=0.05,value=0.25)
    CH=st.number_input("**Ceiling height [m]**", min_value=2, max_value=5, step=0.25, value=3.0)
